...
- Status: open; planned Phase 4 work, revalidated at `80887f8`
- Confidence: high
...
- Current evidence: data URIs still cross runtime events, the unbounded in-memory asset map, GTK render state, and generated message HTML; no restricted WebKit asset scheme is registered
- Partial groundwork: trusted download URLs, MIME headers, per-download size limits, and hashed filenames are already enforced
