...
- Status: open; implementation prepared after `9d9019b`, release measurement pending
- Confidence: high
...
- Next step: verify real Slack images/video seeking and collect the controlled release-build before/after PSS, document-size, and cache-size measurements before closure
